...
return [
    ...
    | como as regras de tamanho. Sinta-se à vontade para ajustar aqui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O valor inserido em :attribute apareceu em um vazamento de dados. Escolha um :attribute diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para substituir os placeholders dos atributos
    | por nomes mais amigáveis ao usuário, como "Endereço de E-mail" em vez de
    | "email".
    |
    */
